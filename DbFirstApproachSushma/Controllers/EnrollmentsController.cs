...
using DbFirstApproachSushma.Models;

namespace DbFirstApproachSushma.Controllers
{
    public class EnrollmentsController : Controller
    {
        private readonly UniversitySushmaContext _context;

        public EnrollmentsController(UniversitySushmaContext context)
        {
            _context = context;
        }
        ...
        {
            var universitySushmaContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await universitySushmaContext.ToListAsync());
        }
